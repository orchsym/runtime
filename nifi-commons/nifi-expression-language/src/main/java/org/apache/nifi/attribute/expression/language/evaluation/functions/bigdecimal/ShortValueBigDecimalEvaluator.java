 ...
 * BigDecimal 转short
 */
public class ShortValueBigDecimalEvaluator extends NumberEvaluator {

    private final Evaluator<BigDecimal> subject;

    @SuppressWarnings("unchecked")
    public ShortValueBigDecimalEvaluator(Evaluator<?> subjectEvaluator) {
    ...
    public QueryResult<Number> evaluate(Map<String, String> attributes) {
        ...
        return new NumberQueryResult(subjectValue.shortValue());
    }
