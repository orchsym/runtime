 ...
 * BigDecimal 转float
 */
public class FloatValueBigDecimalEvaluator extends NumberEvaluator {

    private final Evaluator<BigDecimal> subject;

    @SuppressWarnings("unchecked")
    public FloatValueBigDecimalEvaluator(Evaluator<?> subjectEvaluator) {
    ...
    public QueryResult<Number> evaluate(Map<String, String> attributes) {
        ...
        return new NumberQueryResult(subjectValue.floatValue());
    }
