...
/**
 * 
 * @author LiGuo BigDecimal 比较
 */
public class CompareToBigDemEvaluator extends NumberEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<BigDecimal> compar;

    public CompareToBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<BigDecimal> compar) {
    ...
    public QueryResult<Number> evaluate(final Map<String, String> attributes) {
        ...
        result = (Integer) subjectValue.compareTo(val);
