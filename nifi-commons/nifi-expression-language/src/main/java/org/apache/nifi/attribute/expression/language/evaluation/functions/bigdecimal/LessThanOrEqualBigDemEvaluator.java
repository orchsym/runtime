...
/**
 * 
 * @author LiGuo BigDecimal 小于等于
 */
public class LessThanOrEqualBigDemEvaluator extends BooleanEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<BigDecimal> compar;

    public LessThanOrEqualBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<BigDecimal> compar) {
