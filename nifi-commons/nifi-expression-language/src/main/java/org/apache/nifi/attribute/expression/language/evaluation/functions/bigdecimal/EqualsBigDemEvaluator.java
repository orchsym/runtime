...
/**
 * 
 * @author LiGuo BigDecimal 是否相等
 */
public class EqualsBigDemEvaluator extends BooleanEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<BigDecimal> compar;

    public EqualsBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<BigDecimal> compar) {
    ...
    public QueryResult<Boolean> evaluate(final Map<String, String> attributes) {
        ...
        result = (boolean) subjectValue.equals(val);
        
        return new BooleanQueryResult(result);
    }
