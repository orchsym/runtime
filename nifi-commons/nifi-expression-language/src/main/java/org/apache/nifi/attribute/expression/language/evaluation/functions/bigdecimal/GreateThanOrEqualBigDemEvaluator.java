...
/**
 * 
 * @author LiGuo BigDecimal 大于等于
 */
public class GreateThanOrEqualBigDemEvaluator extends BooleanEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<BigDecimal> compar;

    public GreateThanOrEqualBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<BigDecimal> compar) {
