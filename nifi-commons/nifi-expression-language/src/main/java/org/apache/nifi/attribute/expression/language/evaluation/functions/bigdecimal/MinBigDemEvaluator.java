 ...
 * BigDecimal 最小值
 */
public class MinBigDemEvaluator extends BigDecimalEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<BigDecimal> plusValue;

    public MinBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<BigDecimal> plusValue) {
    ...
    public QueryResult<BigDecimal> evaluate(final Map<String, String> attributes) {
        ...
        BigDecimal result  = (BigDecimal) subjectValue.min(val);
