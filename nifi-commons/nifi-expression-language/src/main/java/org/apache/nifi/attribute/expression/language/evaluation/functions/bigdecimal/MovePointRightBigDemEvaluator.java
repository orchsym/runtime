 ...
 * BigDecimal 向右移n位
 */
public class MovePointRightBigDemEvaluator extends BigDecimalEvaluator {

    private final Evaluator<BigDecimal> subject;
    private final Evaluator<String> n;

    public MovePointRightBigDemEvaluator(final Evaluator<BigDecimal> subject, final Evaluator<String> n) {
    ...
    public QueryResult<BigDecimal> evaluate(final Map<String, String> attributes) {
        ...
        BigDecimal result = (BigDecimal) subjectValue.movePointRight(moveNum);
