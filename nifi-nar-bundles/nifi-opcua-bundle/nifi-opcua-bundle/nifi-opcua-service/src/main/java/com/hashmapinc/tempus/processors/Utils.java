    ...
    public static KeyPair getCert(String applicationName, String cert, String key, org.opcfoundation.ua.transport.security.SecurityPolicy securityPolicy) {
        ...
        try {
            ...
            try {
                 ...
                 * <p>
                 * The OPC UA specification defines that the algorithm should be (at least) "SHA1WithRSA" for application instance certificates used for security policies Basic128Rsa15 and Basic256.
                 * For Basic256Sha256 it should be "SHA256WithRSA".
                 * <p>
                 */
