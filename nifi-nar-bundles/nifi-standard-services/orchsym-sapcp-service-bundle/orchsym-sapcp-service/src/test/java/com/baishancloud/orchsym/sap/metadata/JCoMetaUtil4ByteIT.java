...
public class JCoMetaUtil4ByteIT extends AbsImportExportTestJCoMetaUtil {

    public JCoMetaUtil4ByteIT(ESAPParamType paramType, int nucLength, int length) {
