...
(function (root, factory) {
    ...
    var loadRegistries = function (dialog, registryCombo, bucketCombo, flowCombo, selectBucket, bucketCheck) {
        return $.ajax({
            type: 'GET',
            url: apiHost + "/nifi-api/flow/registries",
            dataType: 'json'
    ...
    var loadBuckets = function (registryIdentifier, bucketCombo, flowCombo, selectBucket, bucketCheck) {
        return $.ajax({
            type: 'GET',
            url: apiHost + "/nifi-api/flow/registries/" + encodeURIComponent(registryIdentifier) + '/buckets',
            dataType: 'json'
    ...
    var saveFlowVersion = function () {
        ...
        return $.ajax({
            ...
            url: apiHost + "/nifi-api/versions/process-groups/" + encodeURIComponent(processGroupId),
            dataType: 'json',
    ...
    var loadFlowVersions = function (registryIdentifier, bucketIdentifier, flowIdentifier) {
        ...
        return $.ajax({
            type: 'GET',
            url: apiHost + "/nifi-api/flow/registries/" + encodeURIComponent(registryIdentifier) + '/buckets/' + encodeURIComponent(bucketIdentifier) + '/flows/' + encodeURIComponent(flowIdentifier) + '/versions',
            dataType: 'json'
        }).done(function (response) {
    ...
    var loadFlows = function (registryIdentifier, bucketIdentifier, selectFlow) {
        return $.ajax({
            type: 'GET',
            url: apiHost + "/nifi-api/flow/registries/" + encodeURIComponent(registryIdentifier) + '/buckets/' + encodeURIComponent(bucketIdentifier) + '/flows',
            dataType: 'json'
        }).done(function (response) {
            var versionedFlows = [];
    ...
    var importFlowVersion = function () {
        ...
        return $.ajax({
            ...
            url: apiHost + "/nifi-api/process-groups/" + encodeURIComponent(nfCanvasUtils.getGroupId()) + '/process-groups',
            dataType: 'json',
            contentType: 'application/json'
        }).done(function (response) {
    ...
    var changeFlowVersion = function () {
        ...
        var submitChangeRequest = function () {
            ...
            return $.ajax({
                ...
                url: apiHost + "/nifi-api/versions/update-requests/process-groups/" + encodeURIComponent(processGroupId),
                dataType: 'json',
                contentType: 'application/json'
            }).done(function () {
    ...
    var updateProcessGroup = function (processGroupId) {
        if (nfCanvasUtils.getGroupId() === processGroupId) {
            ...
            $.ajax({
                type: 'GET',
                url: apiHost + "/nifi-api/flow/process-groups/" + encodeURIComponent(processGroupId),
                dataType: 'json'
            }).done(function (response) {
    ...
    var loadLocalChanges = function (processGroupId, localChangesMessage, localChangesTable, totalLabel) {
        ...
        var loadChanges = $.ajax({
            type: 'GET',
            url: apiHost + "/nifi-api/process-groups/" + encodeURIComponent(processGroupId) + '/local-modifications',
            dataType: 'json'
        }).done(function (response) {
            ...
            if (nfCommon.isDefinedAndNotNull(response.versionControlInformation)) {
                ...
                var submitRevertRequest = function () {
                    ...
                    return $.ajax({
                        ...
                        url: apiHost + "/nifi-api/versions/revert-requests/process-groups/" + encodeURIComponent(processGroupId),
                        dataType: 'json',
                        contentType: 'application/json'
                    }).done(function () {
                        // initialize the progress bar value
                ...
                yesHandler: function () {
                    $.ajax({
                        ...
                        if (nfCommon.isDefinedAndNotNull(response.versionControlInformation)) {
                            ...
                            $.ajax({
                                type: 'DELETE',
                                url: apiHost + "/nifi-api/versions/process-groups/" + encodeURIComponent(processGroupId) + '?' + $.param(revision),
                                dataType: 'json',
                                contentType: 'application/json'
                            }).done(function (response) {
