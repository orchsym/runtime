...
(function (root, factory) {
    ...
    var config = {
        urls: {
            ...
            searchTenants: apiHost + "/nifi-api/tenants/search-results"
        }
    };
    ...
    var loadPolicy = function () {
        ...
        if (resourceAndAction.resource.startsWith('/policies')) {
            ...
            policyDeferred = $.Deferred(function (deferred) {
                $.ajax({
                    type: 'GET',
                    url: apiHost + "/nifi-api/policies/" + resourceAndAction.action + resourceAndAction.resource,
                    dataType: 'json'
