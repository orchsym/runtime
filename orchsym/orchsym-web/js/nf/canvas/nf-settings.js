...
(function (root, factory) {
    ...
    var config = {
        urls: {
            ...
            controllerConfig: apiHost + "/nifi-api/controller/config",
            reportingTaskTypes: apiHost + "/nifi-api/flow/reporting-task-types",
            createReportingTask: apiHost + "/nifi-api/controller/reporting-tasks",
            reportingTasks: apiHost + "/nifi-api/flow/reporting-tasks",
            registries: apiHost + "/nifi-api/controller/registry-clients"
        }
    };
